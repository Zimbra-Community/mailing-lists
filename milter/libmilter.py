...
#
ACCEPT = pack_uint32(1) + bytes(SMFIR_ACCEPT, 'utf-8')
CONTINUE = pack_uint32(1) + bytes(SMFIR_CONTINUE, 'utf-8')
REJECT = pack_uint32(1) + bytes(SMFIR_REJECT, 'utf-8')
TEMPFAIL = pack_uint32(1) + bytes(SMFIR_TEMPFAIL, 'utf-8')
DISCARD = pack_uint32(1) + bytes(SMFIR_DISCARD, 'utf-8')
CONN_FAIL = pack_uint32(1) + bytes(SMFIR_CONN_FAIL, 'utf-8')
SHUTDOWN = pack_uint32(1) + bytes(SMFIR_SHUTDOWN, 'utf-8')
# }}}
